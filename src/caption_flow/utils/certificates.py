...
class CertificateManager:
    ...
    def generate_self_signed(self, output_dir: Path, domain: str = "localhost") -> tuple[Path, Path]:
    ...
    def generate_letsencrypt(self, domain: str, email: str, 
                           output_dir: Optional[Path] = None,
                           staging: bool = False) -> tuple[Path, Path]:
        """
