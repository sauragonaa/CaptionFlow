...
class TestGenerateLetsEncrypt:
    ...
    @patch('subprocess.run')
    def test_generate_letsencrypt_certbot_failure(self, mock_subprocess, cert_manager, temp_output_dir):
    ...
    @patch('subprocess.run')
    def test_generate_letsencrypt_missing_files(self, mock_subprocess, cert_manager, temp_output_dir):
