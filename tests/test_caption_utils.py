...
class TestCaptionUtilsCombine:
    ...
    def test_categorization_characters(self):
        ...
        assert any(keyword in full_result for keyword in ["landscape", "mountains", "person", "wearing", "animal", "running"])
    ...
    def test_category_order(self):
        ...
        assert any(word in full_text for word in ["mystical", "forest", "character", "blue", "hair"])
...
class TestCaptionUtilsValidateCaption:
    ...
    def test_validate_borderline_cases(self):
        ...
        assert CaptionUtils.validate_caption("the warrior refuses to surrender in this epic battle scene") == True
        
        # Should pass - contains generic word but in longer context
        assert CaptionUtils.validate_caption("this beautiful picture shows a magnificent sunset over mountains") == True
...
class TestCaptionUtilsIntegration:
    ...
    def test_full_pipeline(self):
        ...
        assert any(word in result_lower for word in ["castle", "dragons", "flying", "fantasy", "mystical", "towers", "atmosphere"])
